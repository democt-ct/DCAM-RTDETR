...
def draw(images, labels_list, boxes_list, scores_list, thrh=0.7,
         path="/media/democt/82F4E8B9F4E8B119/zhuomian/detr code/rtdetr code/pcbdataset-infer/you", image_names=[]):
...
if __name__ == '__main__':
    ...
    parser.add_argument('-r', '--resume', type=str, default=r'/media/democt/82F4E8B9F4E8B119/zhuomian/detr code/rtdetr code/RT-DETR-main/rtdetr_pytorch/tools/output/96ci/pcb-dataset/amsf+gpa/checkpoint0094.pth')   #指定训练权重文件路径
    ...
    parser.add_argument('--im-dir', type=str, default=r'/media/democt/82F4E8B9F4E8B119/zhuomian/detr code/rtdetr code/pcbdataset-infer/you', help="Directory containing images to predict")
    # parser.add_argument('-nc', '--numberofboxes', type=int, default=25)                                                                                  #切片模式下的切片数量
    parser.add_argument('-o', '--output-dir', type=str, default=r'/media/democt/82F4E8B9F4E8B119/zhuomian/detr code/rtdetr code/pcbdataset-infer/you/infer', help="Path to the directory where output images will be saved.")                               # 新增输出目录参数

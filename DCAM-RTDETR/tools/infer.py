...
if __name__ == '__main__':
    ...
    parser.add_argument('-c', '--config', type=str,
                        default=r'D:\zhuomian\detr code\RT-DETR-main\rtdetr_pytorch\configs\rtdetr\rtdetr_r18vd_6x_coco.yml')
    parser.add_argument('-r', '--resume', type=str,
                        default=r'D:\zhuomian\detr code\RT-DETR-main\rtdetr_pytorch\tools\output\rtdetr_r18vd_6x_coco\checkpoint0068.pth')
    parser.add_argument('-f', '--im-file', type=str,
                        default=r'z')  # D:\zhuomian\detr code\RT-DETR-main\infer\\
    parser.add_argument('-s', '--sliced', type=bool, default=False)
    parser.add_argument('-d', '--device', type=str, default='cuda')
    parser.add_argument('-nc', '--numberofboxes', type=int, default=25)
    parser.add_argument('-o', '--output-dir', type=str, default='valouts')  # 新增输出目录参数
